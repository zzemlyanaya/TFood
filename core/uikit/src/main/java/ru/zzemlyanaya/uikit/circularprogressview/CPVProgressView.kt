...
class CPVProgressView @JvmOverloads constructor(
    ...
    private fun obtainAttributes() {
        context.obtainStyledAttributes(
            ...
            val strokeCapInt =
                it.getInt(R.styleable.CPVProgressView_CPV_strokeCap, CPVStrokeCap.ROUND.index)
            val strokeCapNullable =
                CPVStrokeCap.values().find { enum -> enum.index == strokeCapInt }
            ...
            direction =
                CPVDirection.values()[it.getInt(R.styleable.CPVProgressView_CPV_direction, 0)]
