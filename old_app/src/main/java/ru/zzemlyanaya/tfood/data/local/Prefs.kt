...
class Prefs(prefs: KryptoPrefs) : KryptoContext(prefs) {
    ...
    private val userData =
        string(PrefsConst.FIELD_USER_DATA, "Username;1991-1-1;180;65;85") //имя;возраст;рост;вес;гк
    ...
    fun setPref(key: String, value: Any) {
        when (key) {
            ...
            PrefsConst.FIELD_USER_TOKEN -> prefs.putString(
                PrefsConst.FIELD_USER_TOKEN,
                value as String
            )
            ...
            PrefsConst.FIELD_MACRO_NORM -> prefs.putString(
                PrefsConst.FIELD_MACRO_NORM,
                value as String
            )
            PrefsConst.FIELD_MACRO_NOW -> prefs.putString(
                PrefsConst.FIELD_MACRO_NOW,
                value as String
            )
            ...
            PrefsConst.FIELD_USER_DATA -> prefs.putString(
