    ...
    private fun setUpCalendar() {
        val myCalendarViewManager = object : CalendarViewManager {
            ...
            override fun bindDataToCalendarView(
                ...
                holder.itemView.findViewById<TextView>(R.id.textItemDay).text =
                    DateUtils.getDayNumber(
                        date
                    )
                holder.itemView.findViewById<TextView>(R.id.textItemWeekDay).text =
                    DateUtils.getDay3LettersName(
                        date
                    )
            }
        }
