...
class DashboardFragment : Fragment() {
    ...
    private val articlesViewModel by lazy {
        ViewModelProviders.of(requireActivity()).get(ArticlesViewModel::class.java)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        articlesViewModel.articleList.observe(viewLifecycleOwner, { list ->
            ...
            (binding.storiesRecyclerView.recycler.adapter as ArticleRecyclerAdapter).update(
                list.slice(
                    0..lastIndex
                )
            )
    ...
    private fun setUpCaloriesWidget(norm: List<String>, now: List<String>, addit: List<String>) {
        ...
        val fats =
            CPVSection(amount = now[2].toFloat(), color = resources.getColor(R.color.primaryColour))
        ...
        val carbs =
            CPVSection(amount = now[3].toFloat(), color = resources.getColor(R.color.primaryColour))
    ...
    private fun setUpWaterWidget(waterNorm: Int, waterNow: Int) {
        ...
        val water = CPVSection(
            name = "water",
            amount = waterNow.toFloat(),
            color = resources.getColor(R.color.waterBlue)
        )
    ...
    private fun showCongrats(type: CongratsTypes) {
        ...
        when (type) {
            CongratsTypes.WATER -> binding.congratsBase.text =
                getString(R.string.water_goal_reached)
            ...
            CongratsTypes.DIET_ALL -> binding.congratsBase.text =
                getString(R.string.diet_goal_reached)
            CongratsTypes.NONE -> {
            }
        }
